...
$doccmd @list __PROG__=!@1-47
 
$include $lib/strings

$def prop_aliasesdir "_prefs/alias/"
$def prop_aliases "_prefs/alias/a%s"
$def prop_globalowner "_aliasowner/%s"

: alias-global-registry prog ;
: alias-get prop_aliases fmtstring getpropstr ;
...
public alias-get $libdef alias-get
public alias-global-registry $libdef alias-global-registry
 
$pubdef ref_lib_alias __PROG__
$pubdef alias-expand __PROG__ "rtn-expand" call
$pubdef alias-expand-quiet __PROG__ "rtn-expand-quiet" call
$pubdef alias-tell-unknown __PROG__ "rtn-tell-unknown" call
$pubdef cmd-alias __PROG__ "cmd-set" call
$pubdef pmatch me @ swap alias-expand-quiet pop dup if 0 array_getitem else pop #-1 then
.
c
q
@register lib-alias=lib/alias
@register #me lib-alias=tmp/prog1
@set $tmp/prog1=3
@set $tmp/prog1=L
@set $tmp/prog1=V
@action alias=#0=tmp/exit1
