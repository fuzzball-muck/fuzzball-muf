...
c
q
@register #me cmd-whodoing=tmp/prog1
@set $tmp/prog1=3
@set $tmp/prog1=V
...
List the names, on times, idle times, and doings for everyone online. If a 
<name> is given, only lists people whose names start with <name>. wd #wf only 
lists people in your watchfor list, and wd #room only lists people in the 
room with you. wd #species lists species settings instead of doings. The #def 
options lets you set the default options for your use of wd.
.end
@action whodoing;wd;@who=#0=tmp/exit1
