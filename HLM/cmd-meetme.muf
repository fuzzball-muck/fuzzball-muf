...
c
q
@register #me cmd-meetme=tmp/prog1
@set $tmp/prog1=3
@set $tmp/prog1=V
...
Joins or summons player <name>. If you haven't already been asked to join or 
summon <name>, they will be notified you asked; they can then use the 
opposite action to join or summon you. That is:
 
1. You 'mjoin Widget'. Widget is notified you want to join him.
2. Widget 'msummons <you>'. You are transported to where Widget is.
.end
@action meetme;meet;mjoin;msummon;mcancel;mdecline=#0=tmp/exit1
