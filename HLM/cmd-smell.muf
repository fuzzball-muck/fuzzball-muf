...
c
q
@register #me cmd-smell=tmp/prog1
@set $tmp/prog1=3
@set $tmp/prog1=V
...
smell here
smell #set [<message>]
smell #format [<message>]
@set <object>=_prefs/smell:<message>
 
Reach out and smell someone. Smelling a room smells everything inside it too. 
Use #set and #format to set the message a sniffer and you respectively see 
when someone smells you. @set the _prefs/smell command on objects to give 
them smells, too. You can also use 'feel' or 'taste' in place of 'smell'. 
Some %-substitutions are made in notification #formats:
 
  %N    The smeller's real name; use %n for nickname.
  %v    Present tense verb (smell, feel, taste)
  %ved  Past tense verb (smelled, felt, tasted)
  %obj  What the smeller smelled ("you" or "here")
.end
@action smell;feel;taste=#0=tmp/exit1
