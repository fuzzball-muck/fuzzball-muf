...
c
q
@register cmd-watchfor=lib/wf
@register #me cmd-watchfor=tmp/prog1
@set $tmp/prog1=3
@set $tmp/prog1=L
@set $tmp/prog1=V
@set $tmp/prog1=W
@propset $tmp/prog1=dbref:_cancall:$lib/away
@propset #0=dbref:_connect/announce:$tmp/prog1
lsedit $tmp/prog1=_help
.del 1 999
.i 1
watchfor: displays presence of players in your watchfor list
 
wf          Displays your list's presence information.
wf #on      Messages you with presence information as it happens.
wf #off     Turns off messages; type wf to see presence.
wf <name>   Adds <name> to your list; watches someone's presence.
wf !<name>  Removes <name> from your list.
wf #list    Lists the players whose presence you watch.
 
wf #hide <names>  Hides your presence information from <names>.
wf #hideall       Hides from everyone.
wf #!hideall      Hides from no one (default).
wf #show <names> "Unhides" from <names>, when set #hideall.
wf #hide          Shows your current permission settings.
                  People from whom you hide still see you in WHO, etc.
                  Remove people from lists with "!<name>".
 
wf #idle  wf #!idle  Toggles players' idle times on "wf" display.
wf #away  wf #!away  Toggles messages when players you watch go "away".
                     #idle defaults off and #away defaults on.
.end
