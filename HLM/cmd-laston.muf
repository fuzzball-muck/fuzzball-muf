...
List the last time the people with the given names were online. If #wf is 
given, lists everyone in your watchfor, which can be quite a few people. If 
#here is given, lists everyone in the room with you at the time.
.end
@action laston;last=#0=tmp/exit1
