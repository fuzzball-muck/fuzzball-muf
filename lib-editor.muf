...
$include $lib/edit
$iflib $lib/gui $include $lib/gui $endif
...
: EDITORparse ( {str_rng} mask currline cmdstr --
    ...
    7 pick " " swap over strcat strcat sms swap instr if
        0 exit
    then
